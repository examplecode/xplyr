...
var defaults$1 = {
  ...
  selectors: {
    ...
    container: '.plyr',
    loadingSpinner: '.plyr-loading-spinner',
    topControls: {
      container: null,
      wrapper: '.top__controls'
    },
    controls: {
      container: null,
...
var topControls = {
  inject: function inject() {
    console.log("======== start inject  top container ===========");
    var container = null;
    container = topControls.create.call(this); // Controls container

    var target; // Inject into the container by default
  ...
  create: function create() {
    var container = createElement('div', getAttributesFromSelector(this.config.selectors.topControls.wrapper));
    var html = "<button id='plyr-exit' class=\"plyr__controls__item plyr__control\" type=\"button\"><svg t=\"1585468532221\" class=\"icon\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"2231\" width=\"96\" height=\"96\"><path d=\"M766.976 1021.952c-10.24 0-20.48-3.584-28.672-10.752l-509.952-472.576c-15.872-14.336-15.872-38.4 0-52.736l509.952-472.576c15.872-14.336 40.96-14.336 56.832 0 15.872 14.336 15.872 38.4 0 52.736l-481.28 445.952 481.28 445.952c15.872 14.336 15.872 38.4 0 52.736-7.68 7.168-17.92 11.264-28.16 11.264z\" p-id=\"2232\"></path></svg></button>" + "<span>" + this.config.title + "</span>";

    if (this.config.supportCast) {
      html = +"<button id='plyr-cast' class='plyr__controls__item plyr__control right'><svg t=\"1586517008049\" class=\"icon\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"12732\" width=\"96\" height=\"96\"><path d=\"M981.333333 128H42.666667v213.333333h85.333333V213.333333h768v597.333334h-298.666667v85.333333h384V128zM42.666667 768v128h128c0-70.826667-57.173333-128-128-128z m0-170.666667v85.333334c117.76 0 213.333333 95.573333 213.333333 213.333333h85.333333c0-165.12-133.546667-298.666667-298.666666-298.666667z m0-170.666666v85.333333a384 384 0 0 1 384 384h85.333333c0-259.413333-210.346667-469.333333-469.333333-469.333333z\" p-id=\"12733\" fill=\"#ffffff\"></path></svg></button>";
    }

    container.innerHTML = html;
    var btn = container.querySelector("#plyr-exit");

    if (btn) {
      btn.addEventListener("click", function () {
        if (mbrowser) {
          window.player.fullscreen.exit();
          mbrowser.exitMediaPlayer();
        }
      });
    }

    var btn2 = container.querySelector("#plyr-cast");

    if (btn2) {
      btn2.addEventListener("click", function () {
        if (window.mbrowser) {
          mbrowser.castCurrentMedia();
        }
      });
    }
...
var loadingSpinner = {
  inject: function inject() {
    console.log("======== start inject  loading spainner ===========");
    var spinner = null;
    spinner = loadingSpinner.create.call(this); // Controls container
    ...
    var insertMethod = is$1.element(spinner) ? 'insertAdjacentElement' : 'insertAdjacentHTML';
    target[insertMethod]('afterbegin', spinner);
  },
  create: function create() {
    var spinner = createElement('div', getAttributesFromSelector(this.config.selectors.loadingSpinner));
    return spinner;
  }
};
...
var ui = {
  ...
  build: function build() {
    ...
    topControls.inject.call(this);
    loadingSpinner.inject.call(this); // Inject custom controls if not present
